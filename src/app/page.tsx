    ...
    <div className="font-display bg-background-light text-slate-900 overflow-hidden h-screen w-full flex flex-col">
      <header className="flex h-14 items-center justify-between border-b border-slate-200 bg-white px-4 shrink-0 z-20 relative shadow-sm">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:flex items-center gap-1 bg-white border border-slate-200 p-1 rounded-lg shadow-sm">
          <Button variant="ghost" size="icon" className="text-primary bg-primary/10 hover:bg-primary/20 h-8 w-8" title="Select">
            <span className="material-symbols-outlined text-[20px]">arrow_selector_tool</span>
          </Button>
          <Button variant="ghost" size="icon" className="text-slate-500 hover:text-slate-900 hover:bg-slate-100 h-8 w-8" title="Rectangle">
            <span className="material-symbols-outlined text-[20px]">crop_square</span>
          </Button>
          <Button variant="ghost" size="icon" className="text-slate-500 hover:text-slate-900 hover:bg-slate-100 h-8 w-8" title="Diamond">
            <span className="material-symbols-outlined text-[20px]">diamond</span>
          </Button>
          <Button variant="ghost" size="icon" className="text-slate-500 hover:text-slate-900 hover:bg-slate-100 h-8 w-8" title="Text">
            <span className="material-symbols-outlined text-[20px]">text_fields</span>
          </Button>
          <div className="w-px h-5 bg-slate-200 mx-1"></div>
          <Button variant="ghost" size="icon" className="text-slate-500 hover:text-slate-900 hover:bg-slate-100 h-8 w-8" title="Connect">
            <span className="material-symbols-outlined text-[20px]">arrow_right_alt</span>
          </Button>
          <Button variant="ghost" size="icon" className="text-slate-500 hover:text-slate-900 hover:bg-slate-100 h-8 w-8" title="Pen">
            <span className="material-symbols-outlined text-[20px]">edit</span>
          </Button>
          <Button variant="ghost" className="flex items-center gap-1 px-2 py-1 text-purple-600 bg-purple-50 hover:bg-purple-100 rounded text-xs font-bold ml-1 h-8">
        ...
        <div className="flex items-center gap-3">
          <div className="flex -space-x-2">
            <Avatar className="size-8 border-2 border-white ring-2 ring-white">
              <AvatarImage src="https://lh3.googleusercontent.com/aida-public/AB6AXuCDYF6-n1LJbGV2sXxU4ygnW9jdrNk9WPqwwgzfUO7_lJqjEv_MRgC6od3iis-p7PQRvEBEx9BdAEP2gFiJNmS1tcJ2lyshLqJ4lmcaqdLtQpAlA-adKHEf7cMIoDrxZMTHfUUoP3RXTi3yRyEEcJLNg1oOdxLi7RV8EV9fCQQzLQQheL6W0_yvlc5z_EXwmKMYT5D-1ykOjCRm3Byn9QWxa5oA1bOvVM7F8RIxMaOM0O9hbpXJ2dP4haxDx4aW8ABw8uhIvyrNxDE" alt="User avatar 1" />
              <AvatarFallback>U1</AvatarFallback>
            </Avatar>
            <Avatar className="size-8 border-2 border-white ring-2 ring-white">
              <AvatarImage src="https://lh3.googleusercontent.com/aida-public/AB6AXuBTTtMSMH90P97Jg6DyJRh0labqNdtu1tknUgEi38DJEuIFzJBTvL01gNVmtQJmzaae8RYjwIKY5ugWwf9r9qFXxHJhaDGHzzCqlUnWv4Ibik0XNVDiGqjjQcxwER1St7C7q__30F8TvW7RTfpyYwkW4AZRvXNondFZeIvB0G0igniK_Ds-klr8mbr0oi9H7rMlC51_2IW-ymGaJ4HFT9l7rG5GCIlsPiNq40z0lM7zP30a4Xr15AjnOOW2e1TQOd-3nkjLi1H5YN0" alt="User avatar 2" />
              <AvatarFallback>U2</AvatarFallback>
            </Avatar>
            <div className="size-8 rounded-full ring-2 ring-white bg-primary text-white flex items-center justify-center text-xs font-bold shadow-inner z-10 relative">+3</div>
          </div>
          <Button className="h-8 bg-primary hover:bg-primary/90 text-white flex items-center gap-2">
            <span className="material-symbols-outlined text-[18px]">share</span>
                        Share
          </Button>
          <Button variant="ghost" size="icon" className="size-8 text-slate-500 hover:text-slate-900 hover:bg-slate-100">
